...
\begin{definition}
  The \textbf{terminal-coalgebra \(\omega^{\op}\)-chain}\marginnote{terminal-algebra \(\omega^\op\)-chain} is the diagram
    \begin{equation}
...
\begin{example}
  ...
  The limit is the object \(\Sigma^\omega\) of \(\Sigma\)-stream with limit projections \(l_n : \Sigma^\omega \to \Sigma^\omega\) such that \(l_n\) is the left-hand projection of
  \begin{equation*}
  ...
  \begin{itemize}
  \item \(\head(x_1, x_2, x_3, \ldots) = x_1\);
  \item \(\tail(x_1, x_2, x_3, \ldots) = (x_2, x_3, \ldots)\).
  \end{itemize}
\end{example}
