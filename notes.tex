...
\begin{tcolorbox}
  TODO: in the introduction something about coproducts and notation.
  Also notation for functors.
\end{tcolorbox}
...
\begin{tcolorbox}
  TODO: initial/terminal objects in introduction.
\end{tcolorbox}
...
\begin{tcolorbox}
  TODO: explain (co)limit preservation in the preliminaries.
\end{tcolorbox}
...
\begin{proof}
  ...
  Indeed (1) commutes because \(\overline{h}\) is an algebra homomorphism, (2) by (insert reference to the preliminaries) and (3) because of Notation \ref{not:brackets}.
