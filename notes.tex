...
Notice that \(\alpha, \alpha_\omega\) and \(\alpha_{\omega + 1}\) being injective (thus mono) plays a crucial role in the argument above; this suggests that we should look into monomorphisms and, particularly, subobjects.
...
In the particular case of \(\Set\) the four conditions of Theorem \ref{teo:initial-algebra-theorem} are equivalent with no need to require the functor to preserve \(\mathcal{M}\).
