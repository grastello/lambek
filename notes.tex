...
\begin{example}
  ...
  For a cardinal \(\kappa\) we denote by \(K_\kappa\) the loop-free graph on \(\kappa\) vertexes such that any two distinct vertexes are always adjacent; these graphs are also called complete graphs.
  ...
  However the initial-algebra chain of \(F\) never converges because all its elements have increasing cardinalities.
\end{example}
