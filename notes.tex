...
\begin{example}
  ...
  This is, in hindsight, because of Theorem \ref{} and Remark \ref{rem:powset-no-term-coalgebra} but can be proved directly.
...
\begin{proof}
  ...
  \item[(2)]
    ...
    Now from \(u_i = u \cap v_i\) being non-empty, \(x \in \im(Fu)\), \(x \in \im(Fv_i)\) (which we have from definition of \(U\) and hypothesis on \(x\)) and Lemma \ref{} we obtain that \(x\in\im(Fu_i)\) for all \(i < \lambda\).
