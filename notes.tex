...
\begin{example}
  ...
  In order to obtain deterministic automata as coalgebras for a functor we curry the \(\delta_s\)'s into a single function \(\delta:S \to S^\Sigma\) and consider \(\chi : S \to \{0, 1\}\) the characteristic function of \(A\).
