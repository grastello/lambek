...
\begin{notation}
  ...
  We shall also write \(z \cap y\) for the inclusion \(z \cap y : Z \cap Y \rightarrowtail X\) of the intersection of two subsets \(z : Z \rightarrowtail X\) and \(y: Y \rightarrowtail X\).
\end{notation}
